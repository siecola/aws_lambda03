...
>  To read this page in English, click [here](https://github.com/siecola/aws_lambda03/blob/master/README.md).

Nesse exemplo será apresentado como criar uma função Lambda para consumir arquivos importados no **S3** e gravar seus dados em uma tabela do **DynamoDB**.
