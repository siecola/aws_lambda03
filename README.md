...
> Para ler essa página em Português, clique [aqui](https://github.com/siecola/aws_lambda03/blob/master/README.pt-br.md).

In this example, we will introduce how to create a Lambda function to consume imported files in **S3** and write their data to a **DynamoDB** table.
